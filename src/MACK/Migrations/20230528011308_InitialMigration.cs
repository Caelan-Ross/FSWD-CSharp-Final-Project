...
namespace MACK.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fuel = table.Column<string>(type: "varchar(128)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    exterior_colour = table.Column<string>(type: "varchar(128)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    interior_colour = table.Column<string>(type: "varchar(128)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    body_door_count = table.Column<int>(type: "int(1)", nullable: false),
                    weight = table.Column<int>(type: "int(5)", nullable: false),
                    features = table.Column<string>(type: "varchar(128)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    description = table.Column<string>(type: "varchar(128)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    dimensions = table.Column<string>(type: "varchar(128)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    is_used = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    is_automatic = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    model_id = table.Column<int>(type: "int(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Vehicles",
                columns: new[] { "vehicle_id", "body_door_count", "description", "dimensions", "exterior_colour", "features", "fuel", "interior_colour", "is_automatic", "is_used", "model_id", "vin", "weight", "model_year" },
                values: new object[] { -1, 1, "Test description", "1x1x1", "ExtTest", "Test features", "TestFuel", "IntTest", true, true, -1, "11111111111111111", 4000, 2000 });
