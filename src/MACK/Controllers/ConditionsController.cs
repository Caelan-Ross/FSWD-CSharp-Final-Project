...
namespace MACK.Controllers
{
    public class ConditionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ConditionId,ConditionName")] Condition condition)
        {
            if (ModelState.IsValid)
            {
                ConditionHandlers.CreateCondition(condition.ConditionName);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ConditionId,ConditionName")] Condition condition)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ConditionHandlers.UpdateCondition(condition);
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            Condition condition = ConditionHandlers.GetConditionById(id);
            if (condition != null)
            {
                ConditionHandlers.DeleteCondition(condition);
            }
